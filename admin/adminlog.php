<?php
 ...
 if(isset($_POST['res']))
 {
  $u=$_POST["name"];
  $p=$_POST["pass"];
$retrive=mysqli_query($con,"select * from admin_master where username='$u'");
...
<footer>
  ...
  &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made  <i class="fa fa-heart" aria-hidden="true"></i><a href="#" target="_blank">urmila</a>
