...
<div class="report-container">
                <div class="report-header">
                    <h1 class="recent-Articles"> job applied</h1>
                ...
                <div class="report-body">
                    ...
                    $c=1;
                   $id=$_GET['id'];
                    $query="select * from candidate_view where cid='$id';";
                    ...
                    <div class="items">
                        <div class="item1">
                           ...
                           <td><h3 class="t-op-nextlvl"> <button style="background-color:red" ; type="button"  class="view" onclick="return conform('Do you want to delete?')">Delete</button></h3></td>
                    </tr>
                        </div>
