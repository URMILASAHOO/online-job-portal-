<?php
 ...
 if(isset($_POST['res']))
 {
  $u=$_POST["name"];
  $p=$_POST["pass"];
$retrive=mysqli_query($con,"select * from employe_master where username='$u'");
...
if($row>0)
{
    $data=mysqli_fetch_array($retrive);
     ...
     if($rpass==$p)
     {
        $_SESSION['id']=$data['eid'];
        $_SESSION['name']=$data['username'];
       
  echo"<script>window.location='edash.php'</script>";
     }
     else
     {
...
<div class="wrapper">
	<div class="header">
		<div class="top">
			<div class="logo">
				<img src="../assets/img/logo/logo.png" alt="instagram" style="width: 175px;">
			</div>
			<div class="form">
		...
		<div class="signup">
			<p>New User? <a href="employeres.php">Sign up</a></p>
			<form>
		</div>
...
<footer>
  ...
  &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">URMILA</a>
